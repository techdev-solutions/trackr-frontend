define(['lodash'], function(_) {
    'use strict';
    return ['$stateParams', '$scope', 'Restangular', '$state', '$filter', 'base.services.confirmation-dialog',
        function($stateParams, $scope, Restangular, $state, $filter, confirmationDialogService) {
            $scope.errors = [];
            /**
