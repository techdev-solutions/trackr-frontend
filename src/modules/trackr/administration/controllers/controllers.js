...
], function(EmployeeEditController, EmployeeListController, RolesBaseController, RolesListController, CompaniesListController, CompaniesEditController, CompaniesNewController) {
    'use strict';
    return {
