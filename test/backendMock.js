define(['fixtures'], function(fixtures) {
    ...
    return function($httpBackend) {
        ...
        $httpBackend.whenGET(/^api\/invoices\/search\/findByIdentifierLikeAndInvoiceState\?identifier=%25\w+%25&page=\d+&projection=\w+&size=\d+&sort=creationDate&state=\w+/).respond(fixtures['api/invoices']);
